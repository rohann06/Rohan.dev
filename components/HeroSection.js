          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-around">
            <div className=" lg:pr-14">
              ...
              <p className=" lg:text-lg p-1 pt-3 text-[#767676] font-Mulish w-[100%] lg:w-[85%]">
                My{" "}
                <a
                  href="https://docs.google.com/document/d/1FMQuLooz-mZBGHDijt5WJLOWwLEm2F2RTrNEePALWKs/edit?usp=sharing"
                  target="_blank"
            ...
            <div className=" relativ overflow-hidden h-[15rem] w-[15rem] lg:h-[22rem] lg:w-[20rem]">
              <Image
                src={"/mypic.jpg"}
                width={400}
                height={400}
