...
const About = () => {
  return (
    <div className=" flex flex-col lg:flex-row justify-center items-center gap-5 py-[8rem] lg:py-[15rem]">
      <div>
        <Image
          src={img}
          height={200}
      ...
      <div className=" text-center lg:text-left lg:px-10 lg:w-[600px]">
        ...
        <p className=" text-[#8e8e8e]">
          ...
          skills in <span className=" text-black font-medium">Next.js , JavaScript , Typescript, Tailwind CSS and PostgreSQL</span> . I excel in build and maintaining responsive websites that
